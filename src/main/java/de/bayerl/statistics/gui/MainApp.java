package de.bayerl.statistics.gui;
import de.bayerl.statistics.gui.controller.MainViewController;
import de.bayerl.statistics.gui.controller.MenuBarController;
import de.bayerl.statistics.gui.model.programLogic.Handler;
import de.bayerl.statistics.gui.model.storageStructure.ListWrapper;
...
public class MainApp extends Application {
    ...
    public void loadTransformations(File file) {
        try {
            ...
            ListWrapper wrapper = (ListWrapper) u.unmarshal(file);
            transformations.clear();
            transformations.addAll(wrapper.getTransformations());
